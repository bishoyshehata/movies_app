...
class GetRecommendationsUseCase extends BaseUseCase<List<Recommendations>,MovieDetailsParameters>{
  final BaseMoviesRepository moviesRepository ;

  GetRecommendationsUseCase(this.moviesRepository);

  @override
  Future<Either<Failure, List<Recommendations>>> call(MovieDetailsParameters parameters) async{
