...
import '../controllers/movie_detailas_bloc.dart';
import '../controllers/movie_detailas_event.dart';
import '../controllers/movie_detailas_state.dart';
      ...
      builder: (context, state) {
        switch (state.movieDetailsState) {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            'App Genres: ${_showGenres(state.movieDetails!.genres)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
          ...
          case RequestState.error:
            return Center(child: Text(state.movieDetailsError));
        }
      },
    );
  }
